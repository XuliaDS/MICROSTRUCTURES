...
int main(int argc, char **argv)
{
    ...
    Tile = UserMicro3DCrossTile(&UMinPrms, &UMaxPrms,
				&VMinPrms, &VMaxPrms,
				&WMinPrms, &WMaxPrms);
    IPPutObjectToFile3("c:/temp/TileSolid1.itd", Tile, 0);
    IPFreeObject(Tile);
    ...
    Tile = UserMicro3DCrossTile(&UMinPrms, &UMaxPrms,
				&VMinPrms, &VMaxPrms,
				&WMinPrms, &WMaxPrms);
    IPPutObjectToFile3("c:/temp/TileSolid1diff.itd", Tile, 0);
    IPFreeObject(Tile);
    ...
    Tile = UserMicro3DCrossTile(&UMinPrms, &UMaxPrms,
				&VMinPrms, &VMaxPrms,
				&WMinPrms, &WMaxPrms);
    IPPutObjectToFile3("c:/temp/TileHollowed1.itd", Tile, 0);
    IPFreeObject(Tile);
    ...
    Tile = UserMicro3DCrossTile(&UMinPrms, &UMaxPrms,
				&VMinPrms, &VMaxPrms,
				&WMinPrms, &WMaxPrms);
    IPPutObjectToFile3("c:/temp/TileHollowed1diff.itd", Tile, 0);
    IPFreeObject(Tile);
